...
.service('definitions', function () {
  ...
  return {
    ...
    concepts: {
      ...
      historicalPaperCitationCount: 'historical paper citation count',
      latestPaperCitationCount: 'latest paper citation count',
      personCitationCount: 'person citation count',
      historicalPersonCitationCount: 'historical person citation count',
      latestPersonCitationCount: 'latest person citation count',
      coAuthorStatistic: 'co-author statistic',
      topicPersonStatistic: 'topic-person statistic',
      topicOrganisationStatistic: 'topic-organisation statistic',
      person: 'person',
      ...
      internalConferencePaper: 'internal conference paper',
